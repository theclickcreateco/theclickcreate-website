...
if (!process.env.NEXT_PUBLIC_CONTENTFUL_SPACE_ID || !process.env.NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN) {
  ...
  console.error('NEXT_PUBLIC_CONTENTFUL_SPACE_ID:', process.env.NEXT_PUBLIC_CONTENTFUL_SPACE_ID ? 'Set' : 'Missing');
  console.error('NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN:', process.env.NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN ? 'Set' : 'Missing');
}
