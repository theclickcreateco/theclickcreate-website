  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/theclickcreateco@gmail.com",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="p-8 md:p-12 bg-secondary/20">
        ...
        <div className="mb-6 p-4 bg-purple-500/10 border border-purple-500/20 rounded-lg animate-in fade-in slide-in-from-top-2">
          ...
          <div className="flex flex-wrap gap-2">
            {addons.map((addon, i) => (
              <div
                key={i}
                className="flex items-center gap-1 bg-background px-3 py-1 rounded-full text-xs font-medium border border-purple-200"
              >
                {addon}
                <button
      ...
      <form
        ...
        className="space-y-6"
        key={`${plan || "default"}-${addons.length}`}
      >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Shop G13, Regal Trade Square, Saddar, Karachi
                  </p>
                </div>
              </div>
            </div>
